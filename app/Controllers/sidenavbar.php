...
<div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
         ...
         -->
          ...
          <li class=" nav-item"><a href="
            ...
            ?>
             ...
             <i class="icon-home"></i><span class="menu-title" data-i18n="nav.dash.main">Dashboard</span></a></li>

            <li class=" nav-item"><a href="<?php echo base_url(); ?>contacts " ?><i class="icon-list"></i><span class="menu-title" data-i18n="nav.dash.main">Contacts</span></a></li>



            <li class=" nav-item"><a href="#"><i class="icon-link"></i><span class="menu-title" data-i18n="nav.dash.main">Attendance</span></a>
            ...
            <ul class="menu-content">
              ...
              <?php
                ...
                <li class=" nav-item"><a class="menun-item" href="https://form.congreg8.org/markattendance.php?id=<?php echo $att_link; ?>" target="_blank" data-i18n="nav.dash.analytics">

                  <i class=""></i><span class="menu-title" data-i18n="nav.dash.main">Main Church Check-in</span></a></li>
                ...
                <li class=" nav-item"><a href="#"><i class=""></i><span class="menu-title" data-i18n="nav.dash.main">Manage Check-ins</span></a></li>

                <li class=" nav-item"><a href="<?php echo base_url('/attendance')?>"><i class=""></i><span class="menu-title" data-i18n="nav.dash.main">Attendance Log</span></a></li>
          ...
          <li class=" nav-item">
            <a href="<?php echo base_url()."comingsoon"; ?>"><i class="ft-paperclip"></i><span class="menu-title" data-i18n="nav.dash.main">Forms</span></a></li>

          <li class=" nav-item"><a href="<?php echo base_url()."comingsoon"; ?>"><i class="icon-bubbles"></i><span class="menu-title" data-i18n="nav.dash.main">Conversation</span></a></li>

          <li class=" nav-item"><a href="<?php echo base_url()."comingsoon"; ?>"><i class="ft-calendar"></i><span class="menu-title" data-i18n="nav.dash.main">Calendar</span></a></li>

          <li class=" nav-item"><a href="#"><i class="ft-chrome"></i><span class="menu-title" data-i18n="nav.dash.main">Automations</span></a></li>


          <li class=" nav-item"><a href="<?php echo base_url('/interests')?>"><i class="ft-chrome"></i><span class="menu-title" data-i18n="nav.dash.main">Interests</span></a></li>

          

          <li class=" nav-item"><a href="#"><i class="ft-settings"></i><span class="menu-title" data-i18n="nav.dash.main">Settings</span></a>
            ...
            <ul class="menu-content">
                ...
                ?>
                  ...
                  <li class=" nav-item"><a href="<?php echo base_url('churches/');?>"><i class=""></i><span class="menu-title" data-i18n="nav.dash.main">Manage Churches</span></a></li>
              ...
              ?>
                ...
                <li class=" nav-item"><a href="<?php echo base_url(); ?>users" ><i class=""></i><span class="menu-title" data-i18n="nav.dash.main">Users</span></a></li>  
              ...
              <li class=" nav-item"><a href="<?php echo base_url(); ?>integration"><i class=""></i><span class="menu-title" data-i18n="nav.dash.main">Integrations</span></a></li>
            ...
            <?php
              ...
              ?>                   
                  ...
                  <li class=" nav-item"><a href="<?php echo base_url('/churchmanagment');?>"><i class="icon-globe"></i><span class="menu-title" data-i18n="nav.dash.main">Church</span></a></li> 
          ...
          <!-- <li class=" nav-item"><a href="<?php //echo base_url('/attendance')?>"><i class="icon-pencil"></i><span class="menu-title" data-i18n="nav.dash.main">Attendance</span></a></li> -->
              ...
              <!-- <li>
                ...
                <a class="menun-item" href="https://form.congreg8.org/markattendance.php?id=<?php //echo $att_link; ?>" target="_blank" data-i18n="nav.dash.analytics">  

                <i class="icon-link"></i>Attendance Link</a>
              ...
              <!-- <li><a class="menun-item" href="<?php //echo base_url('add-church/'.$userData["user_id"]);?>" data-i18n="nav.dash.analytics"><i class="icon-briefcase"></i>Manage Church</a>
              ...
              <!-- <li><a class="menun-item" href="<?php //echo base_url('/attendence')?>" data-i18n="nav.dash.analytics"><i class="icon-pencil"></i>Attendance</a>
              ...
              <!-- <li><a class="menun-item" href="<?php //echo base_url('/chat-application')?>" data-i18n="nav.dash.analytics"><i class="icon-bubbles"></i>Conversation</a>
              ...
              <!-- <li><a class="menu-item" href="<?php echo base_url(); ?>/chat-application" data-i18n="nav.dash.fitness"><i class="icon-docs"></i>Lead's Chat </a>
              ...
              <li><a class="menu-item" href="#" data-i18n="nav.dash.fitness"><i class="icon-pencil"></i>Report</a>
              ...
              <li><a class="menu-item" href="<?php echo base_url(); ?>/page-pricing" data-i18n="nav.dash.fitness"><i class="icon-basket-loaded"></i>Subscription</a>
        ...
        <!-- </ul> -->
              ...
              <!-- <li><a class="menun-item" href="project-tasks" data-i18n="nav.dash.analytics"><i class="icon-check"></i>Lead's</a>
              ...
              <li class=" nav-item"><a href="add-on-drag-drop"><span class="menu-title" data-i18n="nav.templates.main"><i class="icon-briefcase"></i>Billing</span></a>
            ...
            <ul class="menu-content">
              ...
              <li><a class="menu-item" href="invoice-summary" data-i18n="nav.invoice.invoice_summary">Invoice Summary</a>
              ...
              <li><a class="menu-item" href="invoice-template" data-i18n="nav.invoice.invoice_template">Invoice Template</a>
              ...
              <li><a class="menu-item" href="invoice-list" data-i18n="nav.invoice.invoice_list">Invoice List</a>
...
<!--               
          ...
          <li class=" nav-item"><a href="#"><i class="icon-user"></i><span class="menu-title" data-i18n="nav.users.main">Users</span></a>
            ...
            <ul class="menu-content">
              ...
              <li><a class="menu-item" href="#" data-i18n="nav.users.users_contacts">Users List</a>
