...
define('CONTACTSPROFILE', 'Contacts-Profile');
define('TASKS', 'Tasks');
define('CONVERSATION', 'Conversation');
define('NOTES', 'Notes');
define('USERATTENDANCE', 'User-Attendance');
define('SURVEY', 'Survey');
define('PRAYERREQUEST', 'Prayer-Request');
define('BIPTISMREQUEST', 'Biptism-Request');
define('BIBLE_STUDY', 'Bible_study');
define('TAGS', 'Tags');