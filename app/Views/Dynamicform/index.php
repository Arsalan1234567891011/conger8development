                              ...
                              <div class="card">
                                  <div class="card-content">
                                      ...
                                      <div class="table-responsive">
                                          <table id="form-data" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
                                              <thead>
                                                  <tr>
                                                      <th>Form Title</th>
                                                      <th>Status</th>
...
$(document).ready(function(){
    $(document).on("click", ".fa-eye", function(){
        ...
        $.ajax({
            type: 'POST',
            url: base_url + '/ajaxgetusersubmitteddata', // URL to your CodeIgniter route
            data: {
                id: id
            },
