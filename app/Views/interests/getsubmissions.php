         ...
         <div class="content-wrapper">
            ...
            <div class="content-header row">
               ...
               <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                  ...
                  <h3 class="content-header-title mb-0 d-inline-block">Interests</h3>
                              ...
                              <div class="row">
                                ...
                                <div class="col-3">
                                        <select class="form-control" id="interests">
                                          <option value="">Show All Interests</option>
                                          <option value="surveys">Surveys</option>
                                          <option value="prayer_request">Prayer Requests</option>
                                          <option value="baptism_request">Baptism Requests</option>
                                          <option value="bible_study">Bible Study Requests</option>
                                        </select>
                                ...
                                <div class="col-3">
                                        <select class="form-control" id="survey_type">
                                          <option value="">Show All Surveys</option> 
                                          <option value="community">Community Survey</option> 
                                          <option value="afterchurch">After Church Survey</option>
                                        </select>
                              </div>
                              ...
                              <table class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
                                    ...
                                    <tbody>
                                       ...
                                       foreach ($submissions as $submission) { ?>
                                          ...
                                          <tr>                                
                                            <td><?php echo $i; ?></td>
                                            <td><?php echo $submission['question']; ?></td>
