                     ...
                     <div class="card">                   
                        ...
                        <div class="card-head">
                              ...
                              <div class="row">
                                ...
                                <div class="col-3">
                                        <select class="form-control" id="status">
                                          <option value="">Show All Churches</option> 
                                          <?php
                           ...
                           <div class="card-content">
                              ...
                              <table id="interests-data" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
