         ...
         <div class="content-wrapper">
            ...
            <div class="content-header row">
               ...
               <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                  ...
                  <h3 class="content-header-title mb-0 d-inline-block">Manage Checkins</h3>
                           ...
                           <div class="card-content">
                              ...
                              <div class="card-body">
                                 <div class="row">
                                    ...
                                    <form class="row gx-3 gy-2 align-items-center" action="<?php echo base_url().'savemanagecheckins'; ?>" method="POST">
                                    <input type="hidden" name="id" >
                                       <div class="col-md-12">
                                          <label for="name" class="form-label">Event title</label>
                                          <input type='text' id="mc_title" class="form-control "  name="mc_title" required />
                                       </div>
                                       ...
                                       <div class="col-md-12">
                                          <button type="submit" id="create_btn"class="btn btn-primary w-md">Create New Event</button>
                                          </div>
                                    </form>
                                 </div>
                                 <br>
                              ...
                              <table id="integration-data" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
                                    ...
                                    <tbody>
                                       ...
                                       <?php 
                                       $i = 1;
                                       foreach($data as $integ){ ?>

                                          <tr> 
                                               <td><?php echo $i; ?></td>                     
                                               <td>
                                                <?php echo $integ['mc_title']; ?>
                                               </td>
                                               <td>
                                                <?php echo "https://form.congreg8.org/event_check.php?cid=".$integ['mc_link']; ?>
                                               </td>
                                               <td>
                                                  <i class="icon-trash mc-del" style="color: red;cursor:pointer;" id="<?php echo $integ['mc_id']; ?>"></i>
                                                  <i class="pen ft-edit-2 mc-edit" style="color: green;cursor:pointer;" id="<?php echo $integ['mc_id']; ?>"></i>
                                               </td>                                       
                                          </tr>
...
$(document).ready(function() {
   ...
   $('.mc-edit').on('click', function() {
  // Get the values and make the AJAX request
$('#create_btn').text("");
$('#create_btn').text("Update Event");
