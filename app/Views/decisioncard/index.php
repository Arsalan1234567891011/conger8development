          ...
          <div class="col-xl-12 col-lg-9" id="bg">
            ...
            <div class="card-cont" style="
              ...
              <div class="table-responsive mt-3">
                <div class="row mb-2">
                    <div class="col-12">
                         <a target="_blank" href='<?php echo base_url('/adddecisioncard')."?id=".$att_link; ?>' class="btn btn-danger float-right mt-2 mb-2">Visit Decision Link</a>                               
                    </div>
                </div>  
                <table id="decision" class="table text-nowrap">
                    <thead>
                                       <tr>
                                          <!-- <th>Sr#</th> -->
                                          <th>Name</th>
