				 ...
				 <?php
                  ...
                  ?>
				   ...
				   <div class="col-md-6 mb-2">
                    ...
                    <a class="signupButton"  href="/buyplan/<?php echo $row['pm_id']; ?>/y">  <button style="background: rgb(29, 29, 29); width: 100%; color: #fff; height: 50px;" class="btn mt-3"  href="payment/<?php echo $row['pm_id']; ?>"><?php echo $row['type'];  ?></button></a>
                </div>
