            ...
            <div class="row breadcrumbs-top d-inline-block">
               ...
               <div class="breadcrumb-wrapper col-12">
                  ...
                  <ol class="breadcrumb">
                     ...
                     <li class="breadcrumb-item active">Task
                                 ...
                                 <div class="card-body p-4">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-12">
                                          ...
                                          <button type="submit"class="btn btn-primary w-md float-right" onclick="myFunction()"><i class=" text-white bg-dark plus"></i>Add Task</button> 

                                          <br><br>

                                          <div id="myDIV" style="display:none">

                                             <form class="row gx-3 gy-2 align-items-center" action="<?php echo base_url('tasksave'); ?>" method="POST">
                                                ...
                                                <div class="col-md-6">
                                                   ...
                                                   <input class="form-control" name="title" type="text" id="title" placeholder="Enter your title here">
                                                </div>
                                                   </br>
                                               ...
                                               <?php  
                                               $userchurch_id = get_user_church(session()->user_id);
                                               
                                                ?>
                                                <div class="col-md-6">
                                                   <label for="cars" class="form-label">Assign To</label>
                                                   <select class="form-control" id="assign_to" name="assign_to">
                                                   <option value="">Select an Assignee </option>
                                                   <?php
                                                   foreach(get_user_id_name($userchurch_id) as $row)
                                               {
                                               ?>
                                                         ...
                                                         <ul class="lobilist-items ui-sortable">
                                                            ...
                                                            <li data-id="2" class="lobilist-item">
                                                               ...
                                                               <div class="row">
                                                                  ...
                                                                  <div class="col-4">
                                                                  <div class="fw-bold fs-7 text-primary"><?php echo $user['title']; ?></div>
                                                                  ...
                                                                  <div class="col-3">
                                                                     ...
                                                                     <a class="text-success task-edit-record" onclick="myFunction()" id='<?php echo $user['id'];?>' ><i class="ft-edit-2"></i></a>                                                                         

                                                                     <a class="text-danger task-del-record" id='<?php echo $user['id'];?>' ><i class="ft-trash-2"></i></a> 

                                                                     </div>
                                                                  <div class="col-md-12">

                                                                     <div class="lobilist-item-duedate ">Due : <span class="font-weight-bold"> <?php echo date("Y-m-d ",strtotime($user['due_date']));?></span> </div>
                                                                     <?php $assign_to=$user['assign_to']?>
                                                                     <div class="lobilist-item-duedate  ">Assigned : <span class="font-weight-bold"> <?php echo get_user_name($assign_to) ?> </div>  
