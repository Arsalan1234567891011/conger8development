...
.thankyou-page ._header {
    ...
    padding: 100px 30px;
    text-align: center;
    background: blue url(https://codexcourier.com/images/main_page.jpg) center/cover no-repeat;
}
...
<div class="thankyou-page">
    ...
    <div class="_body">
        <div class="_box">
            <h2>
                <strong>Please check your email</strong> for Verifying your Email and to work with us.
            </h2>
            <p>
    ...
    <div class="_footer">
        ...
        <a class="btn" href="<?php echo base_url() . '/login'; ?>">Back to Login Page</a>
    </div>
</div>
    </body>
