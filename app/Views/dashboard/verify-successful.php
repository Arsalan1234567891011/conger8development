    ...
    <div class="main-email-sec row">
        ...
        <div class="col-md-7">
            <div class="email-verify-sec p-5">
                <div class="p-1">
                    <h3>Thank You For<br>
                        Being a part of Congreg8.</h3>
                    <p>Your Email Verified Successful.</p>
                    <br>
                    <div class="text-center">
                    <img src="<?php echo base_url(); ?>/public/newassets/images/success.png" alt="Successful" width="60px" >
                    </div>
                    <br>
                    <a href="<?php echo base_url(); ?>login" class="btn btn-dark btn-block">Go Back to Log In</a>
