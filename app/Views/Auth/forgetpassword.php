                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form-horizontal" action="login-simple.html" novalidate>
                            ...
                            <a href="<?php echo base_url();?>"type="submit" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i> Recover Password</a>
                        </form>
                    </div>
                </div>
                <div class="card-footer border-0">
                    <p class="float-sm-left text-center"><a href="<?php echo base_url();?>login" class="card-link">Login</a></p>
                    <p class="float-sm-right text-center">New to Robust ? <a href="<?php echo base_url();?>register" class="card-link">Create Account</a></p>
                </div>
            </div>
        </div>
    </div>
