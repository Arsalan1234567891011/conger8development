            ...
            <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-title text-center">
                        ...
                        <div class="p-1"><img src="<?php echo base_url();?>public/app-assets/images/logo/logo-dark.png" alt="branding logo"></div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-simple" action="" novalidate>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-12 text-center text-md-right"><a href="<?php echo base_url();?>forgetpassword" class="card-link">Forgot Password?</a></div>

                            </div>

                            <a href="<?php echo base_url();?>"type="submit" class="btn btn-info btn-lg btn-block"><i class="ft-unlock"></i> Login</a>
                ...
                <div class="card-footer">
                    ...
                    <div class="">
                        ...
                        <p class="float-sm-left text-center m-0"><a href="<?php echo base_url();?>forgetpassword" class="card-link">Recover password</a></p>

                        <p class="float-sm-right text-center m-0">New to Moden Admin? <a href="<?php echo base_url();?>register" class="card-link">Sign Up</a></p>
