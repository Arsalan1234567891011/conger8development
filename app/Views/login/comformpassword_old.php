                ...
                <div class="card-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url('/savenewpassword'); ?>" method="POST">
                        ...
                        <fieldset class="form-group position-relative has-icon-left">
                            <input type="password" class="form-control form-control-lg input-lg" id="password" name="password" placeholder="New Password" required>
                        ...
                        <fieldset class="form-group position-relative has-icon-left">
                            <input type="password" class="form-control form-control-lg input-lg" id="confirm_password" name="confirm_password" placeholder="Reenter Password" required>
                            <div class="form-control-position">
                                <i class="ft-lock"></i>
                            </div>
                        </fieldset>
                        ...
                        <button type="submit" class="btn btn-outline-info btn-lg btn-block" name="forgot_pass">
