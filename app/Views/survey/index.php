  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Survey Answer</h5>
                     ...
                     <div class="card">                   
                        ...
                        <div class="card-head">
                           ...
                           <div class="card-content">
                              ...
                              <table id="survey-data" class="table table-white-space table-bordered row-grouping display no-wrap icheck table-middle">
